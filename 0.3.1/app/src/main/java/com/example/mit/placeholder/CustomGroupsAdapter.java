 ...
 */
public class CustomGroupsAdapter extends ArrayAdapter<GroupProfile> {
    ...
    public CustomGroupsAdapter(Context context, int resource, List<GroupProfile> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DatabaseReference mref = FirebaseDatabase.getInstance().getReference().child("Messages").child(CreateProfile.myuuid).child(group.getUuid());
