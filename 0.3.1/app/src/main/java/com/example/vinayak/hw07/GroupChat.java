...
public class GroupChat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatwith = (GroupProfile) getIntent().getExtras().getSerializable("chatwith");
        mref = FirebaseDatabase.getInstance().getReference().child("GroupMessages");
        ...
        mref.child(chatwith.getUuid()).addValueEventListener(new ValueEventListener() {
            @Override
        ...
        btnsend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(text.length()>0)
                {
                    ...
                    tempmsg.setSender(CreateProfile.myname);
                    ...
                    DatabaseReference pushid = mref.child(chatwith.getUuid()).push();
        ...
        mychatlist.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                mref.child(chatwith.getUuid()).child(delmessage.getPushid()).removeValue(new DatabaseReference.CompletionListener() {
                    @Override
                    ...
                    if (null != selectedImageUri) {
                        ...
                        ImagesRef2.putFile(selectedImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                eachmsg.setSender(CreateProfile.myname);
